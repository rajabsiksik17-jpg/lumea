  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" data-hero-bg-wrap>
        <SmartImage
          src={images.hero}
          alt="Editorial skincare photograph with soft, premium lighting"
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1500px] flex-col px-5 pt-28 md:px-10">
        <div data-hero-content className="flex flex-col items-start">
          ...
          >
            بشرةٌ تُعتنى، نتائج تُرى وتُشعر بها.
          </p>
          ...
          >
            في LUMÉA نمزج بين العلم والجمال لنصنع تجربة متكاملة — من الكريمات والتركيبات الطبية
            إلى حقن الفيلر والاستشارات الجلدية — بمعايير دقيقة تليق ببشرتك.
          </p>
